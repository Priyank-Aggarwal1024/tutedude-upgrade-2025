...
function Footer(props) {
    return (
        <section className="alac-pack-section alac-pack-section-footer">
            <div className="alac-pack-footer">
                <div className="alac-pack-footer-sec alac-pack-footer-sec1">
                    <h4 className="alac-pack-footer-sec-heading">Other Links</h4>
                    <div className="alac-pack-footer-sec-links">
                ...
                <div className="alac-pack-footer-sec alac-pack-footer-sec2">
                    <h4 className="alac-pack-footer-sec-heading">Social Links</h4>
                    <div className="alac-pack-footer-sec-links ">
                        <NavLink className="alac-pack-social-links" to={"/"}>
                ...
                <div className="alac-pack-footer-sec alac-pack-footer-sec3">
                    <h4 className="alac-pack-footer-sec-heading">Contact Us</h4>
                    <div className="alac-pack-footer-sec-links">
                        <p className="alac-pack-footer-email">
                            support@tutedude.com
                        </p>
                        <p className="alac-pack-footer-phone">
                            +91 7988800474
                        </p>
                    </div>
                </div>
                <div className="alac-pack-footer-sec alac-pack-footer-sec4">
                    <h4 className="alac-pack-footer-sec-heading">Registered Office</h4>
                    <div className="alac-pack-footer-sec-links">
                        <div className="alac-pack-footer-address">
